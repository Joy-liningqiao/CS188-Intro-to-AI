...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        "*** YOUR CODE HERE ***"
        self.qValueDict=util.Counter()
        self.nextState={}
        self.statePolicy=util.Counter()
        self.prob=util.Counter()
        self.sampleSize=0
        self.rewardFunc=util.Counter()
    ...
    def getQValue(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        return self.qValueDict[(state, action)]
    ...
    def computeValueFromQValues(self, state):
        ...
        return stateQValueDict[stateQValueDict.argMax()]
    ...
    def computeActionFromQValues(self, state):
        ...
        for action in legalActions:
          stateQValueDict[(state, action)]=self.getQValue(state, action)
        return stateQValueDict.argMax()[1]
    ...
    def update(self, state, action, nextState, reward):
        ...
        self.qValueDict[(state, action)]=(1-self.alpha)*self.qValueDict[(state, action)]+self.alpha*sample
        return self.qValueDict[(state, action)]
